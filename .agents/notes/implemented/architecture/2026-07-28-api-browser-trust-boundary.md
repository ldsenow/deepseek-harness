...
- A non-loopback authority passes the fence but still needs the [pairing token](../feature/2026-08-15-web-lan-pairing-token-tls.md) to be admitted; an unauthenticated `0.0.0.0` deployment no longer exists.
